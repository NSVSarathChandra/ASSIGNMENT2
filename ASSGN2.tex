...
%   \item For $x = \vec{ 0\\
% 2
% }$, we have \\$\vec{1 & -2}x = 1*0+-2*2=-4!=4$\\

% Hence not a solution. \\

%  \item For $x = \vec{ 2\\
% 0
% }$, we have \\$\vec{1 & -2}x = 1*2+-2*0=2!=4$\\

% Hence not a solution.  \\

% \item For $x = \vec{ 1\\
% 1
% }$, we have \\$\vec{1 & -2}x = 1*1+-2*1=-1!=4$\\

% Hence not a solution. \\

% \item For $x = \vec{ \sqrt{2}\\
% 4\sqrt{2}
% }$, we have \\$\vec{1 & -2}x = 1*\sqrt{2}+-2*4\sqrt{2}=-7\sqrt{2} !=4$\\

% Hence not a solution. 
% \end{enumerate}\\


% Therefore, solution is  only \vec{4\\0}
